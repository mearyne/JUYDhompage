...
<body>
	...
	if (logCode != null) {
		...
		if (logCodeInt == -1) {
			...
			System.out.println("logCode 삭제완료");
		}
	}
	...
	<div class="main-container">
		<div class="main-wrap">
			<div class="login-button">
				<button type="button" onclick="location.href='loginUser'">개인</button>
				<button type="button" style="background-color: rgb(176, 176, 176);" onclick="location.href='./loginMaster'">사업자</button>
			</div>
			<section class="login-input-section-wrap">
				<form action="./Service" method="post">
					<input type="hidden" name="command" value="loginMaster">
				...
				<div class="login-button-wrap">
					<button type="button" onclick="location.href='joinMaster'">회원가입</button>
				</div>
			</section>
		</div>
	</div>
